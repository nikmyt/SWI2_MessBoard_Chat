...
export class ApiClient{
    ...
    public static async getSearchResults(term : any):Promise<any[]>{
    ...
    public static async getPostsByUserId(userId : any) : Promise<any[]>
    {
    ...
    public static async getCommentCount(userId : any) {
        try {
